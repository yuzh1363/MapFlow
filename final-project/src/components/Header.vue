  ...
  <header class="header">
    <nav class="navbar">
      ...
      <div class="navbar-content">
        <ul class="nav-menu">
          <li><RouterLink class="nav-item">開始探索</RouterLink></li>
          <li><RouterLink to="/treeHole" class="nav-item">角色樹洞</RouterLink></li>
          <li><RouterLink to="/templete" class="nav-item">樣板市集</RouterLink></li>
          <li><RouterLink class="nav-item">關於我們</RouterLink></li>
        </ul>
